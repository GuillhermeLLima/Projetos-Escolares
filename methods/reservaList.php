<?php
  ...
  if (!empty($pagina)) {
      ...
      $listarTodos = $reservaDAO->listarTodos();

      $dados = "<div class='row bg-body-tertiary rounded p-2'><div class='col-lg mx-auto'><div class='table-responsive'><table class='table table-sm'><thead><tr scope='row'><th>COD</th><th>COD Cliente</th><th>Data de Entrada</th><th>Data de Saída</th><th class='d-flex justify-content-end'>Ações</th></tr></thead><tbody class='table-group-divider'>";
