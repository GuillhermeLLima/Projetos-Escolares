  ...
  <div id="untree_co--overlayer"></div>
    ...
    <nav class="untree_co--site-nav js-sticky-nav">
      ...
      <main class="untree_co--site-main">
        ...
        <div class="untree_co--site-hero inner-page" style="background-image: url('../images/cadastrar.jpg')">
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-md-7 text-center">
                <div class="site-hero-contents" data-aos="fade-up">
                  <h1 class="hero-heading text-white">Cadastre-se</h1>
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="section ">
            ...
            <form action="clienteCad.php" id='cadClienteForm' class='container' enctype="multipart/form-data">
                ...
                <div class='xxl-4 xl-4 lg-3 mb-3'>
                    <label for='senha' class='form-label'>Enereco</label>
                ...
                <div class="row">
                  <div class='col'>
                    <input type='submit' class='btn text-white d-flex justify-content-end' id='cadClienteBtn' value='Cadastrar'>
                  </div>
            </form>
                  <div class="col">
                    <span class="d-flex justify-content-end"><div>Clique <a href="login.php">aqui</a> para Entrar.</div></span>
                  </div> 
                </div>
        ...
        <div class="untree_co--site-section py-5 bg-body-darker cta">
          <div class="container">
            <div class="row">
              ...
              <h3 class="m-0 p-0">Se você tiver uma solicitação especial. Contate-nos.<a href="tel://+5588981703525">+55 (88) 98170 3525</a></h3>              </div>
            </div>
          </div>
        </div>
